...
#define CUSTOM_MACHINE_NAME "AKMAX"
...
//#define PSU_NAME "Power Supply"
  ...
  //#define POWER_OFF_TIMER               // Enable M81 D<seconds> er power-off, with this amount of delay
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #endif
#else
  #define BANG_MAX 280    // Limit hotend current while in bang-bang mode; 255=full current
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 700, 800, 1000, 3000 }
 ...
 *  - Probe to LEFT  of the Nozzleinput_shaping has a Negative X offset
