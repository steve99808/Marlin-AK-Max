...
#define COOLER_AUTO_FAN_PIN PB15
 ...
 */
  ...
  //#define PROBING_MARGIN_LEFT PROBING_MARGIN ((X_BED_SIZE) - (RIGHT_PROBE_BED_POSITION))
  //#define PROBING_MARGIN_RIGHT PROBING_MARGIN 
  //#define PROBING_MARGIN_FRONT PROBING_MARGIN (Y_BED_SIZE_+ BACK_PROBE_BED_POSITION)
